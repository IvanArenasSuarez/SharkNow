  ...
  const abrirModalCrear = () => {
    ...
    const abrirModalEditar = (pregunta) => {
        setModalConfig({
         ...
         setTimeout(() => refEditarPregunta.current?.openModal(), 0);
    }
    ...
    const handleEliminarPregunta = (index) => {
      ...
      // Determinar de qué categoría proviene la pregunta
      const esDeNuevas = preguntasStorage.nuevas.includes(preguntaEliminada);
    
      // Solo agregar a eliminadas si no es de nuevas
      if (!esDeNuevas) {
