...
export default function EditarGuia() {
  ...
  // Cargamos los datos de localStorage si están disponibles
  ...
  // Guardar la guía en localStorage cuando cambia el estado de `guia`
  useEffect(() => {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-6 min-h-[500px]">
          <fieldset>
            ...
            <input 
              ...
              value={guia.nombre || ''} 
              onChange={(e) => setGuia(prev => ({ ...prev, nombre: e.target.value }))} 
            />
          </fieldset>

          {/* Otros campos (materia, academia, etc.) */}
          ...
          <fieldset>
            ...
            <textarea 
              ...
              onChange={(e) => setGuia(prev => ({ ...prev, descripcion: e.target.value }))} 
            />
          </fieldset>
      ...
      {/* Aquí puedes agregar el modal de creación de preguntas */}
    </div>
  );
}