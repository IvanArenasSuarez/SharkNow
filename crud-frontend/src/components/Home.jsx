...
import RecompensaPopup from './RecompensaPopup';
...
export default function Home() {
  ...
  useEffect(() => {
    if (recompensas.length === 0 && !recompensasMostradas) {
  ...
  useEffect(() => {
    if (recompensas.length > 0 && !recompensasMostradas) {
      ...
      setRecompensasMostradas(true);
    }
  }, [recompensas, recompensasMostradas]);
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Mostrar el pop-up de recompensas automáticamente */}
      {popupVisible && (
        <RecompensaPopup
