...
export default function CrearGuia() {
    const [tipoGuia, setTipoGuia] = useState("curricular"); // Estado para el tipo de guía
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col gap-8">
                ...
                <div className={`flex ${tipoGuia === "curricular" ? "lg:flex-row" : "justify-center"} gap-8 min-h-[350px]`}>
                    ...
                    <div className={`w-full ${tipoGuia === "curricular" ? "lg:w-[50%]" : "lg:w-full"} flex flex-col gap-6 flex-grow items-center justify-center`}>
                        <fieldset className="w-full max-w-lg">
                            ...
                            <input type="text" placeholder="Escribe aquí" className="input text-lg w-full" />
                        </fieldset>
